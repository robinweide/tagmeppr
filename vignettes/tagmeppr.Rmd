...
```{r align, eval = TRAVIS, cache=T, cache.lazy=F, message=FALSE,results='hide'}
align(exp = C91, 
...
#### Single insertions
```{r PLOTsingle, eval = TRAVIS, cache=T, cache.lazy=F, fig.align='center', out.width='50%', warning=FALSE}
plotSite(C91,site = 3)
```

```{r PLOTsingle100, eval = TRAVIS, cache=T, cache.lazy=F, fig.align='center', out.width='50%', warning=FALSE}
plotSite(C91,site = 3, maxReads = 100)
```

#### All insertions

```{r PI, eval = TRAVIS, cache=F, cache.lazy=F, fig.align='center', out.width='50%'}
plotInsertions(exp = C91)
```

show orientation:
```{r PIo, eval = TRAVIS, cache=F, cache.lazy=F, fig.align='center', out.width='50%'}
...
```{r PImult1, eval = TRAVIS, cache=F, fig.align='center', cache.lazy=F, out.width='50%'}
plotInsertions(tagMepprSampleList)
```

```{r PImult1o, eval = TRAVIS, cache=F, fig.align='center', cache.lazy=F, out.width='50%'}
plotInsertions(tagMepprSampleList, showOrientation = T)
```


```{r PImult2, eval = TRAVIS, cache=F, cache.lazy=F, fig.align='center', out.width='50%'}
